...
INSERT INTO jogos (codigo, grupo, rodada, fase, etapa, liberado, time_a, time_b, data_jogo, ordem) VALUES
  ...
  ('MM16-01', NULL, NULL, 'mata_mata', '16avos', TRUE, 'Alemanha',      'Paraguai',              '2026-06-29 21:30:00-03', 101),
  ('MM16-02', NULL, NULL, 'mata_mata', '16avos', TRUE, 'França',        'Suécia',                '2026-06-30 22:00:00-03', 102),
  ('MM16-03', NULL, NULL, 'mata_mata', '16avos', TRUE, 'África do Sul', 'Canadá',                '2026-06-28 20:00:00-03', 103),
  ('MM16-04', NULL, NULL, 'mata_mata', '16avos', TRUE, 'Holanda',       'Marrocos',              '2026-06-30 02:00:00-03', 104),
  ('MM16-05', NULL, NULL, 'mata_mata', '16avos', TRUE, 'Portugal',      'Croácia',               '2026-07-03 00:00:00-03', 105),
  ('MM16-06', NULL, NULL, 'mata_mata', '16avos', TRUE, 'Espanha',       'Áustria',               '2026-07-02 20:00:00-03', 106),
  ('MM16-07', NULL, NULL, 'mata_mata', '16avos', TRUE, 'USA',           'Bósnia e Herzegovina',  '2026-07-02 01:00:00-03', 107),
  ...
  ('MM16-14', NULL, NULL, 'mata_mata', '16avos', TRUE, 'Austrália',     'Egito',                 '2026-07-03 19:00:00-03', 114),
  ('MM16-15', NULL, NULL, 'mata_mata', '16avos', TRUE, 'Suíça',         'Argélia',               '2026-07-03 04:00:00-03', 115),
  ('MM16-16', NULL, NULL, 'mata_mata', '16avos', TRUE, 'Colômbia',      'Gana',                  '2026-07-04 02:30:00-03', 116),

  -- Oitavas de final (esquerda)
  ('MMOI-01', NULL, NULL, 'mata_mata', 'oitavas', FALSE, 'A definir', 'A definir', '2026-07-04 22:00:00-03', 121),
  ('MMOI-02', NULL, NULL, 'mata_mata', 'oitavas', FALSE, 'A definir', 'A definir', '2026-07-04 18:00:00-03', 122),
  ('MMOI-03', NULL, NULL, 'mata_mata', 'oitavas', FALSE, 'A definir', 'A definir', '2026-07-06 20:00:00-03', 123),
  ('MMOI-04', NULL, NULL, 'mata_mata', 'oitavas', FALSE, 'A definir', 'A definir', '2026-07-07 01:00:00-03', 124),
  -- Oitavas de final (direita)
  ('MMOI-05', NULL, NULL, 'mata_mata', 'oitavas', FALSE, 'A definir', 'A definir', '2026-07-05 21:00:00-03', 125),
  ('MMOI-06', NULL, NULL, 'mata_mata', 'oitavas', FALSE, 'A definir', 'A definir', '2026-07-06 01:00:00-03', 126),
  ('MMOI-07', NULL, NULL, 'mata_mata', 'oitavas', FALSE, 'A definir', 'A definir', '2026-07-07 17:00:00-03', 127),
  ('MMOI-08', NULL, NULL, 'mata_mata', 'oitavas', FALSE, 'A definir', 'A definir', '2026-07-08 01:00:00-03', 128),

  -- Quartas de final (esquerda)
  ('MMQF-01', NULL, NULL, 'mata_mata', 'quartas', FALSE, 'A definir', 'A definir', '2026-07-09 21:00:00-03', 131),
  ('MMQF-02', NULL, NULL, 'mata_mata', 'quartas', FALSE, 'A definir', 'A definir', '2026-07-10 20:00:00-03', 132),
  -- Quartas de final (direita)
  ('MMQF-03', NULL, NULL, 'mata_mata', 'quartas', FALSE, 'A definir', 'A definir', '2026-07-11 22:00:00-03', 133),
  ('MMQF-04', NULL, NULL, 'mata_mata', 'quartas', FALSE, 'A definir', 'A definir', '2026-07-12 02:00:00-03', 134),

  -- Semifinais
  ('MMSF-01', NULL, NULL, 'mata_mata', 'semi', FALSE, 'A definir', 'A definir', '2026-07-14 20:00:00-03', 141),
  ('MMSF-02', NULL, NULL, 'mata_mata', 'semi', FALSE, 'A definir', 'A definir', '2026-07-15 20:00:00-03', 142),

  -- Disputa de 3º lugar
  ('MM3L-01', NULL, NULL, 'mata_mata', 'terceiro', FALSE, 'A definir', 'A definir', '2026-07-18 22:00:00-03', 151),
